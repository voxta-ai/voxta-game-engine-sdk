...
`pwsh ./Tools/ModelDependencies/VoxtaModel/Validate-VoxtaModelDependencyClosure.ps1` from the repository
...
with the rest of the runtime closure. `Tools/ModelDependencies/VoxtaModel/pinned-model.json`
